...
insert into courses values (4, 'Linj�r algebra');
...
-- Uppgift 1
-- Select:a ut en lista med de olika kurserna, samt hur m�nga studenter det �r p� varje kurs.
SELECT 
...
-- Uppgift 2
-- Select:a ut en lista med de olika studentera, samt hur m�nga kurser varje student g�r.
